...
```{r message=FALSE, warning=FALSE, out.width='60%', fig.align="center", fig.cap="Decision tree build on the training dataset", fig.height=3.2}
...
```{r message=FALSE, warning=FALSE, out.width='60%', fig.align="center", fig.cap="Hyperparameter tuning for `mtry` for random forest using 5 fold cross validation", fig.height=3.2}
...
```{r message=FALSE, warning=FALSE, out.width='60%', fig.align="center", fig.cap="Variable importance plots for random forest model", fig.height=3.2}
